...
@ActiveProfiles("test")
@Transactional
@ContextConfiguration(classes = [NumbleBankingServerChallengeApplication::class])
@ExtendWith(SpringExtension::class)
class MemberServiceTest @Autowired constructor(private val friendshipRepository: FriendshipRepository,private val passwordEncoder: PasswordEncoder, private val memberService: MemberService, private val memberRepository: MemberRepository){
    val username= "Inu"
    val pw1 ="12345"
